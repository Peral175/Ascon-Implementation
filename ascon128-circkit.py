...
def even_mansour():
    ...
    r = ''
    for i in range(320):
        r += str(int(s[i]) ^ int(p[i]))
    # print(bin(812512715624816776440459237248810020064558190857236543862207984151981621179302483734224793854305)[2:].zfill(320))
    print(bin(812545564329713676245859916367026775365407289012783556426457997015311926679201529462946091394920^812512715624816776440913323873270083576047791197409385386197968687102284586828137698161588528485)[2:].zfill(320))
    print(r)
    # print('')
    # 
