...
#sage ExactMatch_AES.py traces/ascon128_r1-clear/ -T $nr_traces -M 0
#
#echo '\nExact attack on ascon r1 isw masking with 2 linear shares.\n'
#sage ExactMatch_AES.py traces/ascon128_r1-isw2/ -T $nr_traces -M 0
#
#echo '\nExact attack on ascon r1 minq.\n'
#sage ExactMatch_AES.py traces/ascon128_r1-minq/ -T $nr_traces -M 0
#
#echo '\nExact attack on ascon r1 quadlin with 2 linear shares.\n'
#sage ExactMatch_AES.py traces/ascon128_r1-ql2/ -T $nr_traces -M 0
