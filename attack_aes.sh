...
#sage ExactMatch_copy.py traces/aes2_clear/ -T $nr_traces -M 0
#
#echo '\nExact attack on aes2 isw masking with 2 linear shares.\n'
#sage ExactMatch_copy.py traces/aes2_isw2/ -T $nr_traces -M 0
#
#echo '\nExact attack on aes2 minq.\n'
#sage ExactMatch_copy.py traces/aes2_minq/ -T $nr_traces -M 0
#
#echo '\nExact attack on aes2 quadlin with 2 linear shares.\n'
#sage ExactMatch_copy.py traces/aes2_quadlin2/ -T $nr_traces -M 0
...
sage LDA_AES.py traces/aes2_quadlin3/ -T $nr_traces -M 0 -W $window_size -S 1